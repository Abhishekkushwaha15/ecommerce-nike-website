export function renderHeader(container) {
  ...
  container.innerHTML = `<nav class="nav section-shell" aria-label="Main navigation">
    ...
    <div class="nav__links"><a href="#/shop" data-nav-path="/shop">New & Featured</a><a href="#/shop" data-nav-path="/shop">Men</a><a href="#/shop" data-nav-path="/shop">Women</a><a href="#/about" data-nav-path="/about">About</a><a href="#/contact" data-nav-path="/contact">Contact</a></div>
